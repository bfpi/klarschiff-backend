...
public class InitializeServiceThread extends Thread {
	...
	/**
	 * Ermittelt ein in der DB vorhandenes Objekt, das zu dem angegebenen Objekt (<code>exampleEntity</code>) passt.
	 * @param exampleEntity Objekt, nach dem in der DB gesucht werden soll.
	 * @return gefundenes Objekt aus der DB oder <code>null</code> wenn kein passendes Objekt in der DB gefunden werden kann.
