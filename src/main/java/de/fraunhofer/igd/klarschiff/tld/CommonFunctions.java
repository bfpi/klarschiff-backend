...
public class CommonFunctions {
  ...
  /**
   * Kodiert einen String in HTML wobei Zeilenumbrüche in <code>&lt;br/&gt;</code> umgewandelt
   * werden.
   */
  ...
  /**
   * Kodiert ein String in HTML wobei zwei aufeinanderfolgende Leerzeichen in
   * <code>&amp;nbsp;&amp;nbsp;</code> umgewandelt werden.
   */
  ...
  /**
   * Kürzt einen String auf eine festgegebenen Länge. Am Ende des neuen Strings werden "..."
   * gesetzt.
   *
  ...
  public static Collection extractArrayItemFromList(Collection listOfArrays, Integer position) {
    ...
    for (Object array : listOfArrays) {
      result.add(((Object[]) array)[position]);
    }
    return result;
  }
}
