...
public class VorgangPrintController {
  ...
  /**
   * Reichert Model mit geoService-Verweis, Vorgangsdaten, -kommentaren und -missbrauchsmeldungen
   * (nicht bei Delegierung) an und liefert View für druckoptimierte Anzeige.
   *
   * @param id Vorgangs-ID
   * @param model Model in der ggf. Daten für die View abgelegt werden
   * @param request Request
