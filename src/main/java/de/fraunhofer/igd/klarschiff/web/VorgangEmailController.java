...
public class VorgangEmailController {
   ...
   * Missbrauchsmeldungen stehen Externen nicht zur Verfügung.
   *
   * @param id Vorgangs-ID
   * @param model Model in der ggf. Daten für die View abgelegt werden
   * @param request HttpServletRequest-Objekt
   ...
   * Objekt (<code>VorgangEmailCommand</code>) mit Vorgangs- und Nutzerinformationen an. In
   * Abhängigkeit vom <code>delegiert</code> Parameter werden Missbrauchsmeldungen angehängt
  ...
  /**
   * Die Methode führt den EMailversand durch. Sie prüft auf Vorhandensein und Gültigkeit der
   * E-Mail-Adresse sowie auf Vorhandensein und maximale Länge von 300 Zeichen des Mail-Textes.
   *
   * @param cmd VorgangEmailCommand
   * @param result BindingResult
   * @param id Vorgangs-ID
