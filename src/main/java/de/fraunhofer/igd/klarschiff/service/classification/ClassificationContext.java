...
/**
 * Die Klasse hält den Kontext für den Klassifikator. Somit kann mit einer Instanz des
 * Klassifikators noch gearbeitet werden, währenddessen im Hintergrund der Klassifikator bereits neu
 * initialisiert und trainiert wird.
 *
