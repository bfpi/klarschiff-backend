 ...
 * <code>org.springframework.security.config.ldap.LdapServerBeanDefinitionParser</code>, so dass
 * durch einfache Konfiguration zwischen einem embedded gestartetem LDAP-Server und einem entfernten
 * LDAP-Server gewechselt werden kann. <br/>
 * Wenn in der <code>settings.properties</code> der Wert der Variable <code>ldap.server.ldif</code>
 * leer ist, wird ein entfernter LDAP-server verwendet. Ansonsten wird mit der im Paramter
 * angegebenen LDIF-Datei ein embedded LDAP-Server gestartet.
 *
