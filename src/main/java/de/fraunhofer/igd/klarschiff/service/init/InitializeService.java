...
/**
 * Klasse zum Initialisieren der DB mit Werten die in der Konfiguration vergegeben werden. Die
 * eigentliche Initialisierung erfolgt innerhalb eines Thread.
 *
...
public class InitializeService {
  ...
  /**
   * Aktionen für das Ausführen eines SQL-Scriptes (z.B. Initialisierung des DbLink mit Trigger und
   * Triggerfunktionen für die Synchronisystion der Frontend- und BackendDB)
   *
   * <code>disabled</code> - SQL-Script wird nicht ausgeführt <br/>
   * <code>warn</code> - SQL-Script wird ausgeführt, Fehler werden ggf. geloggt und die Ausführung
   * des Servers wird bei einem ggf. aufgetretenen Fehler fortgeführt <br/>
   * <code>error</code> - SQL-Script wird ausgeführt, bei einem Fehler wird die Asuführung des
   * Servers abgeberochen
   */
  /**
  ...
  public void afterPropertiesSet() throws Exception {
    if (enable) {
      new InitializeServiceThread(this);
    }
  }
