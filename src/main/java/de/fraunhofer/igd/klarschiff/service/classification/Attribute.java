...
/**
 * Mit Hilfe der Klasse wird die Arbeit mit Attributen, wie sie für Weka benötigt werden,
 * vereinfacht. Die Attribute sind somit mehr an die Arbeitsweise in Klarschiff angepasst. Es werden
 * Grundfunktionen bereitgestellt, um Attribute für Weka einfach zu erzeugen.
 *
...
public class Attribute extends weka.core.Attribute {
  ...
  /**
   * Erzeugt ein Attribut mit einem vorgegebenen Wertebereich. Der Wert des Attributes (Feature des
   * Vorganges) kann sich mit der Zeit ändern.
   *
   * @param name Name des Attributes
   * @param values Wertebereich
   * @return Attribut mit erweiterten Funktionen, wie es auch in Weka verwendet werden kann
   ...
   * dem <code>namePrefix</code> und dem jeweiligen <code>GeoMeasure</code>.
   *
