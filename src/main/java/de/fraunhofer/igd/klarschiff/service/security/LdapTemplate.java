...
public class LdapTemplate extends org.springframework.ldap.core.LdapTemplate {
  ...
  /**
   * Make sure the returnObjFlag is set in the supplied SearchControls. Set it and log if it's not
   * set.
   *
  ...
  /**
   * Close the supplied NamingEnumeration if it is not null. Swallow any exceptions, as this is only
   * for cleanup.
   *
