...
/**
 * Annotation zum kennzeichnen von Jobs, die in einem Cluster nur von einer Serverinstanz
...
public @interface ScheduledSyncInCluster {
  ...
  /**
   * Die Ausführungszeit des Jobs wird zur Synchronisation verwendet. Damit kleine Unterschiede bei
   * den Servern nicht zu einer fehlerhaften Interpretation führen, wird die Ausführungszeit des
   * Jobs auf ein Feld abgerundet.
   *
